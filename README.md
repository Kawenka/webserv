...
| Branche | Description
| :--- | :---:
| `main` | **Version stable du serveur.** Ne jamais coder dessus. Doit toujours compiler sans erreur. |
| `feature/config-parser` | Lecture et parsing du fichier `.conf` et stockage dans les classes de configuration. |
...
| `fix/memory-leaks` | Phase de nettoyage avec **Valgrind** : correction des fuites mémoire, gestion des erreurs et des crashs. |
